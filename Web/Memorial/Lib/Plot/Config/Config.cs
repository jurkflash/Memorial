    ...
    public class Config : IConfig
    {
        ...
        public bool UpdatePlot(PlotDto plotDto)
        {
            ...
            if ((plotInDB.PlotTypeId != plotDto.PlotTypeDtoId
                ...
                && _unitOfWork.PlotTransactions.Find(ct => ct.PlotId == plotDto.Id && ct.DeleteDate == null).Any())
            {
                return false;
            }
        ...
        {
            if (_unitOfWork.PlotTransactions.Find(ct => ct.PlotId == id && ct.DeleteDate == null).Any())
            {
                return false;
            }
        ...
        public bool UpdateItem(PlotItemDto plotItemDto)
        {
            ...
            if ((plotItemInDB.isOrder != plotItemDto.isOrder)
                && _unitOfWork.PlotTransactions.Find(pt => pt.PlotItemId == plotItemDto.Id && pt.DeleteDate == null).Any())
            {
                return false;
            }
        ...
        {
            if (_unitOfWork.PlotTransactions.Find(pt => pt.PlotItemId == id && pt.DeleteDate == null).Any())
            {
                return false;
            }
        ...
        public bool UpdateArea(PlotAreaDto plotAreaDto)
        {
            ...
            if (plotAreaInDB.SiteId != plotAreaDto.SiteId
                && _unitOfWork.PlotTransactions.Find(ct => ct.Plot.PlotAreaId == plotAreaInDB.Id && ct.DeleteDate == null).Any())
            {
                return false;
            }
        ...
        {
            if (_unitOfWork.PlotTransactions.Find(ct => ct.Plot.PlotAreaId == id && ct.DeleteDate == null).Any())
            {
                return false;
            }
