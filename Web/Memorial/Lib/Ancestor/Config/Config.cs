...
namespace Memorial.Lib.Ancestor
{
    public class Config : IConfig
    {
        ...
        {
            if (_unitOfWork.AncestorTransactions.Find(at => at.AncestorItemId == id && at.DeleteDate == null).Any())
            {
                return false;
            }
        ...
        public bool UpdateArea(AncestorAreaDto ancestorAreaDto)
        {
            ...
            if (ancestorAreaInDB.SiteId != ancestorAreaDto.SiteId
                && _unitOfWork.AncestorTransactions.Find(at => at.AncestorItem.AncestorArea.SiteId == ancestorAreaInDB.SiteId && at.DeleteDate == null).Any())
            {
                return false;
            }
        ...
        {
            if (_unitOfWork.AncestorTransactions.Find(at => at.AncestorItem.AncestorArea.SiteId == id && at.DeleteDate == null).Any())
            {
                return false;
            }
