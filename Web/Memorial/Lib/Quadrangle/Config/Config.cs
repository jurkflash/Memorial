    ...
    public class Config : IConfig
    {
        ...
        public bool UpdateQuadrangle(QuadrangleDto quadrangleDto)
        {
            ...
            if ((quadrangleInDB.QuadrangleTypeId != quadrangleDto.QuadrangleTypeDtoId
                ...
                && _unitOfWork.QuadrangleTransactions.Find(qt => (qt.QuadrangleId == quadrangleDto.Id || qt.ShiftedQuadrangleId == quadrangleDto.Id) && qt.DeleteDate == null).Any())
            {
                return false;
            }
        ...
        {
            if (_unitOfWork.QuadrangleTransactions.Find(qt => (qt.QuadrangleId == id || qt.ShiftedQuadrangleId == id) && qt.DeleteDate == null).Any())
            {
                return false;
            }
        ...
        public bool UpdateItem(QuadrangleItemDto quadrangleItemDto)
        {
            ...
            if ((quadrangleItemInDB.isOrder != quadrangleItemDto.isOrder
                ...
                && _unitOfWork.QuadrangleTransactions.Find(qi => qi.QuadrangleItemId == quadrangleItemDto.Id && qi.DeleteDate == null).Any())
            {
                return false;
            }
        ...
        {
            if (_unitOfWork.QuadrangleTransactions.Find(qt => qt.QuadrangleItemId == id && qt.DeleteDate == null).Any())
            {
                return false;
            }
        ...
        public bool UpdateCentre(QuadrangleCentreDto quadrangleCentreDto)
        {
            ...
            if (quadrangleCentreInDB.SiteId != quadrangleCentreDto.SiteId
                && _unitOfWork.QuadrangleTransactions.Find(qt => qt.QuadrangleItem.QuadrangleCentreId == quadrangleCentreInDB.Id && qt.DeleteDate == null).Any())
            {
                return false;
            }
        ...
        {
            if (_unitOfWork.QuadrangleTransactions.Find(qt => qt.QuadrangleItem.QuadrangleCentreId == id && qt.DeleteDate == null).Any())
            {
                return false;
            }
        ...
        public bool UpdateArea(QuadrangleAreaDto quadrangleAreaDto)
        {
            ...
            if (quadrangleAreaInDB.QuadrangleCentreId != quadrangleAreaDto.QuadrangleCentreDtoId
                && _unitOfWork.QuadrangleTransactions.Find(qt => (qt.Quadrangle.QuadrangleAreaId == quadrangleAreaInDB.Id || qt.ShiftedQuadrangle.QuadrangleAreaId == quadrangleAreaInDB.Id) && qt.DeleteDate == null).Any())
            {
                return false;
            }
        ...
        {
            if (_unitOfWork.QuadrangleTransactions.Find(qt => (qt.Quadrangle.QuadrangleAreaId == id || qt.ShiftedQuadrangle.QuadrangleAreaId == id) && qt.DeleteDate == null).Any())
            {
                return false;
            }
