...
namespace Memorial.Lib.Receipt
{
    public class Urn : Receipt, IUrn
    {
        ...
        public Urn(IUnitOfWork unitOfWork, INumber number, ITransaction transaction, IInvoice invoice, IPaymentMethod paymentMethod) : base(unitOfWork, invoice, paymentMethod)
        {
