...
{
    public class Miscellaneous : Invoice, IQuadrangle
    {
        ...
        public bool Create(string AF, float amount, string remark)
        {
            ...
            _invoice.MiscellaneousTransactionAF = AF;
        ...
        {
            return GetInvoicesByMiscellaneousAF(AF);
        }

        public IEnumerable<Core.Dtos.InvoiceDto> GetInvoiceDtos(string AF)
        {
            return GetInvoiceDtosByMiscellaneousAF(AF);
        }
    }
}