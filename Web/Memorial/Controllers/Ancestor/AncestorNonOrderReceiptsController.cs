...
{
    public class AncestorNonOrderReceiptsController : Controller
    {
        ...
        public AncestorNonOrderReceiptsController(
        ...
        public ActionResult Save(NewNonOrderReceiptFormViewModel viewModel)
        {
            ...
            viewModel.ReceiptDto.AncestorTransactionAF = viewModel.AF;
