...
namespace Memorial.Areas.AncestralTablet.Controllers
{
    public class ReceiptsController : Controller
    {
        ...
        public ActionResult Index(string IV)
        {
            ...
            {
                AF = invoice.AncestralTabletTransactionAF,
                AFTotalAmount = _transaction.GetTotalAmount(transaction),
                AFTotalAmountPaid = _receipt.GetTotalIssuedReceiptAmountByAF(invoice.AncestralTabletTransactionAF),
        ...
        public ActionResult Info(string RE, bool exportToPDF = false)
        {
            ...
            var transaction = _transaction.GetByAF(receipt.AncestralTabletTransactionAF);
