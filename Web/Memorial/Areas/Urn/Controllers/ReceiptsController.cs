...
namespace Memorial.Areas.Urn.Controllers
{
    public class ReceiptsController : Controller
    {
        ...
        public ActionResult Index(string IV)
        {
            ...
            {
                AF = invoice.UrnTransactionAF,
                AFTotalAmount = _transaction.GetTotalAmount(transaction),
                AFTotalAmountPaid = _receipt.GetTotalIssuedReceiptAmountByAF(invoice.UrnTransactionAF),
        ...
        public ActionResult Info(string RE, bool exportToPDF = false)
        {
            ...
            var transaction = _transaction.GetByAF(receipt.UrnTransactionAF);
        ...
        public ActionResult Save(NewOrderReceiptFormViewModel viewModel)
        {
            ...
            receipt.UrnTransactionAF = viewModel.AF;
            ...
            if (viewModel.ReceiptDto.RE == null)
            {
                ...
                if (_receipt.Add(transaction.UrnItemId, receipt))
                {
